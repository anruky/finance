#!/usr/bin/env python3
"""
DRAM 多周五到期日期权拉取 (未来 3 个周五)
==========================================
改造 data_puller.py: 原来只拉"下一个周五"(最近到期日),
现在对每个交易日拉"未来 3 个周五"到期日的 near-ATM 期权链,
用于"7天轮动"回测(选 dte 最接近 7 天的那个周五到期日)。

数据源: Polygon.io
输出: /Users/gavinz/git/finance/data/DRAM_options_3fri.json
  ...
  [
    {
      ...
      "spot": 52.34,
      "fridays": [
        {"expiry": "2026-07-31", "dte": 1, "calls": [...], "puts": [...]},
        {"expiry": "2026-08-07", "dte": 8, "calls": [...], "puts": [...]},
        {"expiry": "2026-08-14", "dte": 15, "calls": [...], "puts": [...]}
      ]
    }, ...
  ]
"""
